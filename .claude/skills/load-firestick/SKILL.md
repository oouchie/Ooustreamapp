...
## Inputs
- **Device IP** — a bare last octet like "147" means `192.168.1.147`. Known devices: `.82` / `.84` (AFTKRT), `.66` / `.80` / `.147` / `.154` / `.155` / `.216` / `.244` / `.246` (AFTMA08C15), `.222` / `.245` (Ooustick), `.235` (AFTSSS — mt8695, armeabi-v7a).
